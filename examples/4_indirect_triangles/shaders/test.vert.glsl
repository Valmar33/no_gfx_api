...
layout(buffer_reference) readonly buffer _res_ptr_IndirectData;
...
layout(buffer_reference, scalar) readonly buffer _res_ptr_IndirectData { IndirectData _res_; };
layout(buffer_reference, scalar) readonly buffer _res_indirect_array_IndirectData { IndirectData _res_[]; };
...
layout(push_constant, scalar) uniform Push
{
    ...
    _res_indirect_array_IndirectData _res_indirect_data_;
};
